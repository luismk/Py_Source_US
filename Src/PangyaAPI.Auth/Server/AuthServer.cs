...
using PangyaAPI.Json.ConvertObject;
...
namespace PangyaAPI.Auth.Server
{
    public class AuthServer
    {
        #region Delegates
        public delegate void ConnectedEvent(ClientAuth client);
        public delegate void PacketReceivedEvent(ClientAuth client, AuthPacketInfo packet);
        #endregion
        ...
        /// </summary>
        public GenericDisposableCollection<ClientAuth> Clients = new GenericDisposableCollection<ClientAuth>();
        ...
        private void HandleClient(object obj)
        {
            ...
            AuthPacketInfo packet = ReceivePacket(clientStream);

            var client = new ClientAuth(tcpClient, packet);
        ...
        private static AuthPacketInfo ReceivePacket(NetworkStream clientStream)
        {
        ...
        private void ClientConnected(ClientAuth Server)
        {
        ...
        public virtual void DisconnectClient(ClientAuth Server)
        {
        ...
        public void SendToAll(AuthPacketInfo packet)
        {
        ...
        public void Send(ClientAuth client, AuthPacketInfo packet)
        {
        ...
        public void Send(AuthClientTypeEnum Types, AuthPacketInfo packet)
        {
        ...
        public void UpdateClient(ClientAuth Client)
        {
        ...
        public void RunCommand(string[] Command)
        {
            ...
            switch (Command[0])
            {
                ...
                case "fechar":
                    {
                        WriteConsole.WriteLine("The server was stopped!");
                        Environment.Exit(1);
                    }
                    break;
                default:
